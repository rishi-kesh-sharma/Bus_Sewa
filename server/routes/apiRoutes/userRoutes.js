...
const { updateUserPassword, getSingleUser, getAllUser, updateUserRole, deleteUser,updateUser } =require("../../controller/apiController/user.js"); 
const { authorizeRoles, isAuthorizedUser } = require("../../middleware/auth.js");
...
router.route("/admin/role/:userId").put(authorizeRoles("admin"),updateUserRole)
