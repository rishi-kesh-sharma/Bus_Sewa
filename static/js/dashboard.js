...
// accept and reject btns functionalities in pending booking



console.log("hello")

// remove btns functionalities
...
// request edit action for bookings
...
const requestRemoveAction=(id)=>{
    axios.delete(`http://localhost:3000/api/booking/admin/${id}`).then((response)=>{
